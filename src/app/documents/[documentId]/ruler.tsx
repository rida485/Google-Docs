                        ...
                        {markers.map((marker) => {
                            ...
                            return (
                                ...
                                >
                                    {marker % 10 === 0 && (
                                        <>
                                            <div className="absoulte bottom-0 w-[1px] h-2 bg-neutral-500" />
                                    ...
                                    {marker % 5 === 0 && marker % 10 !== 0 && (
                                        <div className="absoulte bottom-0 w-[1px] h-1.5 bg-neutral-500" />
                                    )}

                                    {marker % 5 !== 0 && (
                                        <div className="absoulte bottom-0 w-[1px] h-1 bg-neutral-500" />
                                    )}
                                </div>
                            )
                        })}
